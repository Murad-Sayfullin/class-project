    ...
    return (
        <div className='modal'>
            ...
            <div className="modal-panel">
                <h3 className="modal-panel__title">Создать учетную запись</h3>
                <p className="modal-panel__subtitle">Введите свой адрес электронной почты и пароль ниже, чтобы создать учетную запись.</p>
                ...
                <form className="modal-form" onSubmit={handleFinish}>
                    <div className="modal-form__group">
                        <label htmlFor="name" className='modal-form__label'>Имя</label>
                        <input type="text" className='modal-form__input' name='name' id='name' required minLength={3} />
                    </div>
                    <div className="modal-form__group">
                        <label htmlFor="email" className='modal-form__label'>Электронная почта</label>
                        <input type="email" className='modal-form__input' name='email' id='email' required />
                    </div>
                    <div className="modal-form__group">
                        <label htmlFor="password" className='modal-form__label'>Пароль</label>
