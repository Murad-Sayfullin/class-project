      ...
      <div className="container">
        {
          items.length <= 0 ?
            <div className='favourite-page favourite-empty'>
              ...
              <h3 className='favourite-empty__title'>Нет продуктов в избранном</h3>
              <p className='favourite-empty__subtitle'>Добавить товары в избранные можно с помощью кнопки ❤️ ️.</p>
              <button className="favourite-empty__btn" onClick={handleHome}>Вернутся</button>
            </div>
            :
            <>
