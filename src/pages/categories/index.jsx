        ...
        <div className="categories-page__wrapper">
          ...
          <div className="categories-page__content">
            ...
            <div className='categories-page__top'>
              <h2 className='categories-page__title'>{products.list.length} товаров в  <span>{categories.list.find(item => item.id === categoryId)?.title}</span></h2>
              ...
              <form className='categories-page__forms'>
                <select name="categories__input" id='select' className='categories-page__select' onChange={handleAsc}>
                  <option value="none" className='categories-page__option'>Показать</option>
                  <option value="asc" className='categories-page__option'>В скидке</option>
                  <option value="desc" className='categories-page__option'>Популярное</option>
                </select>
            ...
            <div className='categories-page__bottom'>
              <select id='categories-select' className='categories-page__select'>
                <option className='categories-page__option'>Страница 1</option>
              </select>
